<header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
            <a class="-m-1.5 p-1.5">
                ...
                <img class="h-8 w-auto" src="{{ asset('img.png') }}" alt="New Company Logo">
            </a>
        </div>
    ...
    <div class="lg:hidden" role="dialog" aria-modal="true" x-show="open" @click.away="open = false" style="display: none;">
