    ...
    <div class="flex flex-col w-full overflow-hidden relative min-h-screen radial-gradient items-center justify-center g-0 px-4">
        <div class="justify-center items-center w-full card lg:flex max-w-md ">
            <div class="w-full card-body">
                ...
                <p class="text-lg leading-8 text-gray-600 text-center pb-4">Let's join with My Todo</p>
                <!-- form -->
                <form action="{{ route('register.submit') }}" method="POST">
                    ...
                    <!-- username -->
                    <div class="mb-4">
                        <label for="forUsername" class="block text-sm font-semibold mb-2 text-gray-600">Name</label>
                        <input type="text" name="name" id="forName" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-600 focus:ring-0" aria-describedby="hs-input-helper-text">
                    </div>
                    <!-- email -->
                    <div class="mb-4">
                    ...
                    <!-- button -->
                    <div class="grid my-6">
                        <button type="submit" class="btn py-[10px] text-base text-white font-medium bg-indigo-600">Register</button>
                    </div>
                    <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 text-center">
                        Already have an account? <a href="/auth/login" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span>Sign in</a>
                    </div>
                </form>
            </div>
        </div>
